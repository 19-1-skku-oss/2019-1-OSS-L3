...
sudo apt install -y git zip unzip python2 python3 python3-pip
...
mkdir extras
mv ORIREADME.md dev-requirements.txt runtests.py tests LICENSE README.md docs graphics setup.cfg tests_django MANIFEST.in examples install.sh requirements.txt setup.py tox.ini extras
clear
